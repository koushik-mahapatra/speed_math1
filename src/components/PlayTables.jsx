...
const PlayTables = () => {
  ...
  // Generate a random multiplication question with multiple options within the specified range
  ...
  const handleOptionSelect = (selectedOption) => {
    const correctAnswer =
      parseInt(question.split(" × ")[0]) *
      parseInt(question.split(" × ")[1].split(" =")[0]);
